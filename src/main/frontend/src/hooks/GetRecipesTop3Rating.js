...
const GetRecipesTop3Rating = ({ persistentData, setPersistentData }) => {
    ...
    const fetchRecipes = () => {
        ...
        const url = "http://localhost:8080/api/v1/recipes/recipes_top_3_rating"
...
export default connect(mapStateToProps, mapDispatchToProps)(GetRecipesTop3Rating);
